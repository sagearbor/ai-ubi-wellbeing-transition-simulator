# Brazil: annual historical predictions
...
**GOOD: 6.5% less error than repeating last year.**

![Brazil Income per person: annual levels and changes](../figures/annual-history-20260917/objective-bra-gdp.png)

## Life expectancy

**GOOD: 50.4% less error than repeating last year.**

![Brazil Life expectancy: annual levels and changes](../figures/annual-history-20260917/objective-bra-life_expectancy.png)

## Unemployment

**GOOD: 6.4% less error than repeating last year.**

![Brazil Unemployment: annual levels and changes](../figures/annual-history-20260917/objective-bra-unemployment.png)

## Wellbeing: one-year forecast

**BAD: 7.1% more error than repeating last year.** This is the annual 0–10 life-evaluation survey score, not a blend of GDP, lifespan and unemployment.

![Brazil annual wellbeing forecast and annual changes](../figures/annual-history-20260917/wellbeing-bra-rolling.png)
...
![Brazil conditional annual wellbeing reconstruction](../figures/annual-history-20260917/wellbeing-bra-conditional.png)
