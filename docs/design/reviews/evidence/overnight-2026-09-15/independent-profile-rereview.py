...
assert h=='4c59f2189699ffcf78e7846c7dacd833150a0ed975a6aa8cdf75b9cfe629bea5'
...
out={'counts':dict(counts),'compressedHash':h,'selected':selected};Path('/private/tmp/independent-profile-rereview-output.json').write_text(json.dumps(out,indent=2));print(json.dumps({'counts':dict(counts),'compressedHash':h}))
