# Archived legacy model evidence

Historical report for old presets, preserved as evidence of earlier behavior. None of its default/candidate labels describe the current shipped default. The anchor fit used 335 observations across 120 countries; 106 refers to the hindcast comparison cohort.
