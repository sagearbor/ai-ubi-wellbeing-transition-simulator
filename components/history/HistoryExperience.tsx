...
export default function HistoryExperience(): React.ReactElement {
  ...
  return <section className="history-experience" aria-labelledby={`${id}-title`}>
    ...
    <section className="history-cohort" aria-labelledby={`${id}-cohort`}>
      ...
      <p>Scores compare 2015–2025 changes or the 2025 endpoint, not all annual points pooled. GDP growth means the total percentage change across this decade. Cross-country GDP growth correlation is not meaningful here: modeled growth is effectively common across countries. This page does not present it as accuracy evidence.</p>
    </section>
